...
- **Arquitectura de Tokens:** Centralización de colores y tipografía en variables CSS globales:
  - **Paleta:** Rosa Pastel (`#E3AAAA`), Azul Cielo (`#87CEEB`), Blanco (`#FFFFFF`) y Negro (`#000000`) para tipografía y bordes.
  - **Tipografía:** `Comfortaa` para impacto emocional en títulos, `Lato` para claridad funcional en contenido base.
