// CartSheet.tsx
// Propósito: Panel lateral del carrito. Se desliza desde la derecha.
// Monta <Elements> de Stripe al abrirse el carrito para pre-inicializar
// el formulario de pago y reducir la latencia al abrir PaymentDialog.
...
export function CartSheet({ open, onOpenChange }: CartSheetProps) {
  ...
  return (
    // Elements se monta aquí para que Stripe inicialice su sesión cuando
    // el usuario abre el carrito, no cuando hace click en "Ir al pago"
    <Elements
