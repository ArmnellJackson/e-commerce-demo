import { A as AstroError, n as MissingSharp } from './entrypoint_CTX-kNOc.mjs';
import { b as baseService, p as parseQuality } from './generic_Dt01Tsbg.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_Dvs6S7Jr.mjs').then(n => n.i)).default;
  } catch {
